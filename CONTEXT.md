...
of a state when the text offers remote; bare, `Texas` is a placeholder for a Place the employer
...
resolved was measured properly, on that one, and is not unresolved (ADR 0016). Surfaced and
flagged, never dropped — silently dropping is how a User loses a role they wanted and never finds
